...
namespace New.Domain.Concrete
{
    public class EmailSettings
    {
        ...
        public string FileLocation = @"d:\Мои документы\Белов В Ю";
    }
    ...
    public class EmailOrderProcessor : IOrderProcessor
    {
        ...
        public void ProcessOrder(Cart cart, RequestDetails shippingInfo)
        {
            using (var smtpClient = new SmtpClient())
            {
                ...
                {
                    var subtotal = line.Material.Cena * line.Quantity;
                    body.AppendFormat("{0} x {1} (итого: {2:c}",
                        line.Quantity, line.Material.name, subtotal);
                }
